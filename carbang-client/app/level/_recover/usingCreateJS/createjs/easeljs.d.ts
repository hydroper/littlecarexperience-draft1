declare module "@createjs/easeljs" {
    ...
    export class EventDispatcher {
        ...
        addEventListener(type: string, listener: Function, useCapture?: boolean): Function | Object;

        removeEventListener(type: string, listener: Function, useCapture?: boolean): void;

        removeAllEventListeners(type?: string): void;

        dispatchEvent(event: Object | string | Event, bubbles?: boolean, cancelable?: boolean): boolean;

        hasEventListener(type: string): boolean;

        on(type: string, listener: Function, useCapture?: boolean): Function | Object;
    ...
    export class DisplayObject extends EventDispatcher {
        ...
        /**
         * Registration (anchor) point's X in percent.
         * A value of 50 means center.
         */
        regX: number;

        /**
         * Registration (anchor) point's Y in percent.
         * A value of 50 means center.
         */
        regY: number;
